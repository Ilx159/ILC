...
#define X(name, type)                                                          \
    ...
    static inline void name##ArrAssign(name##Arr_t *arr, type *data,           \
                                       size_t length);                         \
    ...
    static inline void name##ArrSet(name##Arr_t *arr, size_t index,            \
                                    type value);                               \
    static inline void name##ArrInsert(name##Arr_t *arr, size_t index,         \
                                       type value);                            \
...
#define X(name, type)                                                          \
    ...
    static inline void name##ArrClear(name##Arr_t *arr) { arr->length = 0; }   \
    static inline void name##ArrAddCap(name##Arr_t *arr,                       \
                                       size_t new_capacity) {                  \
    ...
    static inline void name##ArrAssign(name##Arr_t *arr, type *data,           \
        ...
        if (arr->capacity < length) {                                          \
            arr->capacity = length;                                            \
            type *Tp = realloc(arr->data, arr->capacity * sizeof(type));       \
            if (Tp != NULL)                                                    \
                arr->data = Tp;                                                \
        }                                                                      \
        memcpy(arr->data, data, length * sizeof(type));                        \
    ...
    static inline void name##ArrRemove(name##Arr_t *arr, size_t index) {       \
        ...
        memmove(&arr->data[index], &arr->data[index + 1],                      \
                (arr->length - index - 1) * sizeof(type));                     \
        arr->length--;                                                         \
        arr->data[arr->length] = (type)0;                                      \
    }                                                                          \
    static inline u8 name##ArrContains(name##Arr_t *arr, type value) {         \
